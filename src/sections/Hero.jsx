...
export const Hero = () => {
    return <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* Content */}
        <div className="container mx-auto px-6 pt-42 pb-20 relative z-10">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in animation-delay-100">
                            ...
                            Into Powerful 
                            <br/>
                            <span className="font-serif italic font-normal text-white">Digital</span> Products.
                        </h1>
                        <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                            I’m Omar Nasif, a full-stack web developer specializing in the MERN stack 
                            (<span className="text-primary glow-text">MongoDB, Express.js, React, and Node.js</span>). I build modern, responsive,
                            and scalable web applications that focus on performance, usability, and 
                            clean design. 
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
                        <a href="#contact">
                            <Button className="size-lg">Contact Me <ArrowRight className="w-5 h-5"/> </Button>
                        </a> 
                        <AnimatedBorderButton href="/Omar_Nasif_CV.pdf" download="Omar_Nasif_CV.pdf">
                ...
                <div className="relative animate-fade-in animation-delay-300">
                    ...
                    <div className="relative max-w-md mx-auto">
                        ...
                        <div className="relative glass rounded-3xl p-2 glow-border">
                            <img src="ProfilePicUpd.JPG" alt="Profile Pic" className="w-full aspect-square object-cover rounded-2xl"/>
                            ...
                            {/* Stats Badge */}
                            <div className="absolute -top-4 -left-4 rounded-xl glass px-4 py-3 animate-float animation-delay-500 ">
